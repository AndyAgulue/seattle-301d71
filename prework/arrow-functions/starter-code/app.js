...
//    In this context "this" is referring to all the methods in the joe object

// 2. What is "this" when joe.scopeArrow() is invoked?
//    I belive that "this" can only be used in a local scope with Arrow functions

// 3. Explain why "this" is different when an arrow function is used.
//     "this" in affor functions is a lexical scope and is not accessible outside of the function
